...
CLI = os.environ.get(
    "LARK_CLI_PATH",
    "C:/Users/wuchunbo/AppData/Roaming/npm/lark-cli.cmd",
)
HIRE_APP = os.environ.get("HIRE_APP_ID", "cli_aa84d938c8259bd6")  # 飞书招聘应用
...
BASE_TOKEN = os.environ.get("TRACKING_BASE_TOKEN", "KRAQbxQR0aj2ymsuZRvcwHLdnKQ")
TRACK_TABLE = os.environ.get("TRACKING_TABLE_ID", "tblFZcRms15NlGkr")
# 吴春波 open_id（飞书用户标识，用于岗位归属过滤 + 私聊抓取）
WUBO_ID = os.environ.get("WUBO_OPEN_ID", "ou_18a4ddb7512560aea7d7a30cf824a516")
