...
ALLOWED_MEMBER_EXTS = {".pdf", ".docx", ".png", ".jpg", ".jpeg", ".gif", ".bmp"}
# 作品素材扩展名（允许存在于 ZIP 内，但不做姓名/薪酬提取——视频无法 OCR）
# .doc 是老式二进制 Word 格式（python-docx 不支持），按作品素材对待
PORTFOLIO_MEDIA_EXTS = {".mp4", ".mov", ".avi", ".mpg", ".webm", ".psd", ".ai", ".riff", ".ase", ".doc", ".ppt", ".pptx"}
# 简历扩展名（需要做姓名/薪酬提取）
RESUME_MEMBER_EXTS = {".pdf", ".docx"}
