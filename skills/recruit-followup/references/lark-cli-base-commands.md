...
| 参数 | 值 |
|---|---|
| `--base-token` | `KRAQbxQR0aj2ymsuZRvcwHLdnKQ`（候选人管理表 base） |
| `--table-id` | 跟踪表 `tblFZcRms15NlGkr` / 候选人主库 `tbl31hGzsIJrzTWN` |
...
lark-cli base +record-list \
  --base-token KRAQbxQR0aj2ymsuZRvcwHLdnKQ \
  --table-id tblFZcRms15NlGkr \
