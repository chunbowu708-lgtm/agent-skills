...
sys.path.insert(0, os.path.join(os.environ.get("PROJECT_ROOT", os.getcwd()), "notes"))
sys.path.insert(0, os.environ.get("PROJECT_ROOT", os.getcwd()))  # locate_resume 在 notes/_hire.py
